...
Welcome to `SpeakUp` contributor's guide.
...
If you experience bugs or general issues with `SpeakUp`, please have a look
...
You can help improve `SpeakUp` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`SpeakUp` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `SpeakUp`'s files. While this mechanism can
...
```
conda create -n SpeakUp python=3 six virtualenv pytest pytest-cov
conda activate SpeakUp
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/SpeakUp.git
   cd SpeakUp
   ```
...
5. Install [pre-commit]:
   ...
   `SpeakUp` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/SpeakUp
[issue tracker]: https://github.com/<USERNAME>/SpeakUp/issues
